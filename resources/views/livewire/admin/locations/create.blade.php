                    ...
                    <div class="sm:col-span-2">
                        <div class="space-y-2">
                            ...
                            <input wire:model="photos" type="file" multiple accept="image/*"
                                class="block w-full text-sm text-white/80 file:mr-4 file:py-2.5 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-secondary/20 file:text-secondary hover:file:bg-secondary/30 file:transition-colors cursor-pointer bg-white/10 border border-white/20 rounded-lg focus:ring-4 focus:ring-secondary/25" />
                            <p class="text-xs text-white/60">Adicione fotos que mostrem as condições de acessibilidade
                            </p>
                            @error('photos.*')
