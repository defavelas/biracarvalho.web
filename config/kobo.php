...
return [
    ...
    */
    'accessible' => [
        '_3_Que_tipo_de_lugar_esse' => 'Classificação do local',
        '_5_Quais_elementos_to_trutura_e_mobilidade' => 'Infraestrutura e acessibilidade',
        '_5_1_Quais_elementos_porte_e_deslocamento' => 'Deslocamento',
        '_5_2_Quais_elementos_omunica_o_e_intera_o' => 'Comunicação e interação',
        '_5_3_Quais_s_o_os_ou_este_local_acess_vel' => 'O que torna este local acessível',
        '_6_O_entorno_imediat_se_local_acess_vel' => 'Entorno do local',
        '_6_1_Se_n_o_for_acess_descreva_o_problema' => 'Possíveis barreiras',
    ...
    'non_accessible' => [
        '_3_Que_tipo_de_lugar_esse' => 'Classificação do local',
        '_5_Quais_barreiras_d_trutura_e_mobilidade' => 'Infraestrutura e mobilidade',
        '_5_1_Quais_barreiras_porte_e_deslocamento' => 'Deslocamento',
        '_5_2_Quais_barreiras_omunica_o_e_intera_o' => 'Comunicação e interação',
        '_5_3_Quais_s_o_os_ou_bilidade_nesse_local' => 'Problemas de acessibilidade',
        '_3_O_entorno_imediato_desse_lo' => 'Entorno do local',
        '_6_1_Se_n_o_for_acess_descreva_o_problema' => 'Barreiras de acessibilidade',
